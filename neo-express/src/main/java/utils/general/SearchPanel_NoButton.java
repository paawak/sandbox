...
public class SearchPanel_NoButton extends javax.swing.JPanel {
     ...
     *
     */
    public SearchPanel_NoButton(Object[] ListArray) {
...
search();
  ...
  JOptionPane.showMessageDialog(this," Enter valid chararters ","ERROR!",JOptionPane.INFORMATION_MESSAGE);    
     ...
     *
     */ 
public void  sortStrings(Object[] rawData,int rows){
    ...
    unsorted=new String[rows];
     ...
     for(int j=0;j<rows;j++){       
         unsorted[j]=((String)(rawData[j])).trim();
         sorted[j]=unsorted[j];
...
public void search(){
          ...
          try{
            ...
            sortStrings(ListArray,TableRows); 
...
/**
 *
 *Conviniebce method to fill the list with a new Object[] array
 */
    public void fillListWithNewArr(Object[] ListArray){
        this.ListArray=ListArray;
        txtSearch.setText("");
        search();
    }
